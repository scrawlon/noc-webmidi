var circuitMidiApp = (() => {
  ...
  // src/js/novation-circuit-synth.js
  var require_novation_circuit_synth = __commonJS({
    "src/js/novation-circuit-synth.js"(exports, module) {
      (function() {
        var midiCCs = {}, midiComponents = {};
        midiCCs = {
          // Circuit Synths: midi channels 1 and 2
          // Section: Voice
          "3": {
            "name": "Polyphony Mode",
            "range": [0, 2],
  ...
  // src/js/novation-circuit-drums.js
  var require_novation_circuit_drums = __commonJS({
    "src/js/novation-circuit-drums.js"(exports, module) {
      (function() {
        var midiCCs = {}, midiComponents = {};
        midiCCs = {
          // Circuit Drums: midi channel 10
          "8": {
  ...
  // src/js/novation-circuit-session.js
  var require_novation_circuit_session = __commonJS({
    "src/js/novation-circuit-session.js"(exports, module) {
      (function() {
        var midiCCs = {}, midiComponents = {};
        midiCCs = {
          // Circuit Session Control: midi channel 16
          // Section: Reverb
          "88": {
          ...
          "74": {
            ...
            "rangeValues": [-63, 64],
            "rangeConditions": {
              // 0-63=Low Pass, 64=OFF, 65-127=High Pass
              "<64": "Low Pass",
              "=64": "OFF",
              ">64": "High Pass"
            },
  ...
  var require_index = __commonJS({
    "src/js/index.js"(exports, module) {
      (function() {
        "use strict";
        var synth = require_novation_circuit_synth(), drum = require_novation_circuit_drums(), session = require_novation_circuit_session();
        var midiCCs = {
          synth: synth.midiCCs,
          drum: drum.midiCCs,
          session: session.midiCCs
        };
        var midiComponents = getMidiComponents(), midiDrumCCs = getDrumComponents(drum.midiComponents), midiChannels = {
          "0": "synth 1",
          "1": "synth 2",
          "9": "drum",
          "15": "session"
        ...
        function getMidiComponents() {
          ...
          var defaultPatch = /* @__PURE__ */ new Map();
          componentsKeys.forEach(function(key) {
            var value = components[key];
            var componentValues = /* @__PURE__ */ new Map();
            value.forEach(function(v, k) {
              var midiParameters = Object.keys(v), componentArray = [], componentType = "";
        ...
        function getDrumComponents(drumComponents) {
          return drumComponents.map(function(component) {
            return component.settings;
          });
        }
        function getComponentSettings(midiChannel, midiCCObject) {
          var midiCCObjectKeys = Object.keys(midiCCObject), componentSettings = /* @__PURE__ */ new Map();
        ...
        function getMidiSettings(midiChannel, midiCCArray) {
          var midiCCArrayLength = midiCCArray.length, midiSettings = [];
        ...
        function getMidiParameterRange(parameter) {
          var range = parameter.hasOwnProperty("range") ? parameter.range : false, rangeValues = parameter.hasOwnProperty("rangeValues") ? parameter.rangeValues : false;
          return rangeValues ? getRangeValues(range, rangeValues) : getRange(range);
        }
        function getRangeValues(range, rangeValues) {
          var values = {}, rangeStart = range[0], rangeValuesStart = rangeValues[0], rangeValuesType = typeof rangeValues[0], rangeLength = range[1] - range[0];
        ...
        function getRange(range) {
          var values = {}, rangeValuesStart = range[0], rangeLength = range[1];
          for (var i = 0; i < rangeLength + 1; i++) {
  ...
  // src/js/noc-webmidi.js
  (function() {
    "use strict";
    var synth = require_novation_circuit_synth(), drum = require_novation_circuit_drums(), session = require_novation_circuit_session(), circuitMidiApp = require_index();
