...
function getMidiComponents(type = 'cc') {
  ...
  switch (type) {
    case 'cc':
      componentTypes = Object.keys(cc.ccComponents);
      break;
    case 'nrpn':
      componentTypes = Object.keys(nrpn.nrpnComponents);
      break;
    default:
  ...
  componentTypes.forEach(function (component) {
    ...
    const componentSettings = getComponentSettings(cc.ccComponents[component], cc.midiCCs[componentType]);
    ...
    defaultPatch.set(component, {
      midiChannel: cc.midiChannels[component],
...
console.log({ midiComponents });
console.log({ midiChannels: cc.midiChannels });

var midiCCs$h = cc.midiCCs;
var midiChannels = cc.midiChannels;
var midiNRPNs$z = nrpn.midiNRPNs;
export { getCircuitMidiCC, midiCCs$h as midiCCs, midiChannels, midiComponents, midiNRPNs$z as midiNRPNs };
