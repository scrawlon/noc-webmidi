...
function getMidiComponents() {
  const midiCcComponentTypes = Object.keys(cc.ccMidiChannels);
  const midiNrpnComponentTypes = Object.keys(nrpn.nrpnComponents);
  ...
  midiCcComponentTypes.forEach(function (componentType) {
    ...
    midiChannels[componentType] = cc.ccMidiChannels[componentType];
    components[componentType] = {
      'parameters': getComponentSettings(cc.ccComponents[componentType], cc.midiCCs[componentCCType])
    };
...
export { midiCCs$h as midiCCs, midiChannels, midiComponents, midiNRPNs$z as midiNRPNs };
